...
public class FirePedestalBlockEntity extends FireContainer implements IAnimatable {
    ...
    @OnlyIn(Dist.CLIENT)
    public VividFireParticle fireParticle;
    ...
    public void clientTick() {
        if (level instanceof ClientLevel level) {
            ...
            if ((fireParticle == null || !fireParticle.isAlive()) && fire != null) {
                ...
                fireParticle = new VividFireParticle(level, pos.getX() + 0.5, pos.getY() + 1.2f, pos.getZ() + 0.5, fire.colorVale, 0, true);
            ...
            if (fireParticle != null) {
                ...
                fireParticle.setSize(0.15f + .15f * scale);
            }
        }
    }
