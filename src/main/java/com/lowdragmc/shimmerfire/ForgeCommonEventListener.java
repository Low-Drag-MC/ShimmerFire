...
public class ForgeCommonEventListener {
    ...
    public static void onRegisterClientCommands(RegisterCommandsEvent event) {
        event.getDispatcher().register(Commands.literal("bloom_particle").requires((p_138127_) -> p_138127_.hasPermission(2)).then(Commands.argument("name", ParticleArgument.particle()).executes((p_138148_) -> {
